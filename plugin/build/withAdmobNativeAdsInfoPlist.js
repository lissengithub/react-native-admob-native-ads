...
exports.withAdmobNativeAdsPlist = void 0;
const config_plugins_1 = require("@expo/config-plugins");
const withAdmobNativeAdsInfoPlist = (config, props) => {
...
const withAdmobNativeAdsPlist = (config, props) => {
    return withAdmobNativeAdsInfoPlist(config, props);
};
exports.withAdmobNativeAdsPlist = withAdmobNativeAdsPlist;
